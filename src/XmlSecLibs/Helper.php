 ...
 * @param $arAtts
 */
function sortAndAddAttrs(\DOMElement $element, $arAtts)
{
    $newAtts = array();
...
/**
 * @param \DOMDocument|\DomElement $tree
 * @param \DOMElement $element
 * @param $withcomments
 */
function canonical($tree, \DOMElement $element, $withcomments)
{
...
/**
 * @param \DOMElement $element DOMElement for which to produce the canonical version of
 * @param bool $exclusive to indicate exclusive canonicalization (must pass TRUE)
 * @param bool $withcomments indicating wether or not to include comments in canonicalized form
 *
 * @return null|string
 * @throws \Exception
 */
function C14NGeneral(\DOMElement $element, $exclusive = false, $withcomments = false)
{
